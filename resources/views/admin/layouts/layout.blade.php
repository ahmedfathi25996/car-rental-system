                      ...
                      <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="active treeview">
                            <ul class="treeview-menu">
                                <li class="active"><a href="/"><i class="fa fa-user-plus"></i>Go To Website</a></li>
                        ...
                        <li class="active treeview">
                          ...
                          <li class="active treeview">
                            <a href="#">
                              <i class="fa fa-dashboard"></i> <span>Categories Control</span>
                              <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                              </span>
                            </a>
                            <ul class="treeview-menu">
                              <li class="active"><a href="/adminpanel/catego/create"><i class="fa fa-circle-o"></i>Add New Category</a></li>
                              <li><a href="/adminpanel/catego"><i class="fa fa-circle-o"></i> All Categories</a></li>
                            </ul>
                          </li>

                          <li class="active treeview">
                              <a href="#">
                                <i class="fa fa-car" ></i> <span>Cars Control</span>
                                <span class="pull-right-container">
                                  <i class="fa fa-angle-left pull-right"></i>
                                </span>
                              </a>
                              <ul class="treeview-menu">
                                <li class="active"><a href="/adminpanel/cars/create"><i class="fa fa-car" style="color:white"></i>Add New Car</a></li>
                                <li><a href="/adminpanel/cars"><i class="fa fa-car" style="color:white"></i> All Cars</a></li>
                              </ul>
                            </li>

                            <li class="active treeview">
                                <a href="#">
                                  <i class="fa fa-book" ></i> <span>Booking Control</span>
                                  <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                  </span>
                                </a>
                                <ul class="treeview-menu">
                                  <li class="active"><a href="/adminpanel/booking/create"><i class="fa fa-circle-o"></i>Add New Reservation
                                  </a></li>
                                  <li><a href="/adminpanel/booking"><i class="fa fa-circle-o"></i> All Reservations
                                  </a></li>
                                </ul>
                              </li>
                              ...
                              <li class="active treeview">
                                <a href="#">
                                  <i class="fa fa-book" ></i> <span>Blogs Control</span>
                                  <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                  </span>
                                </a>
                                <ul class="treeview-menu">
                                  <li class="active"><a href="/adminpanel/blogs/create"><i class="fa fa-circle-o"></i>Add New Post
                                  </a></li>
                                  <li><a href="/adminpanel/blogs"><i class="fa fa-circle-o"></i> All Posts
                                  </a></li>
                                </ul>
                              </li>
