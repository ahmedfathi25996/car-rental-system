            ...
            <div class="row">
                <div class="col-lg-8 post-list blog-post-list">
                            ...
                            <div class="user-details row align-items-center">
                                <div class="comment-wrap col-lg-6 col-sm-6">
                                    <ul>
                                        ...
                                        <li><a href="#"><span class="lnr lnr-bubble"></span> {{$comments->count()}} Comments</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="comment-list">
                                    <div class="single-comment justify-content-between d-flex">
                                        <div class="user justify-content-between d-flex">
                                            <div class="thumb">
                                                <img src='{{ asset("images/{$comment->user->image}") }}' alt="" style="width:70px;height:70px;>
                                            </div>
                                            <div class="desc">
                    ...
                    <section class="commentform-area pt-80">
                        <div class="container">
                            <form  action="{{ url('/singleblog') }}" method="POST">
                                {{ csrf_field() }}
                                <input name="post_id" type="hidden" value="{{$blogs->id}}">
                                
                            <h5 class="pb-50">Leave a Reply</h5>
                            <div class="row flex-row d-flex">
                               
                                <div class="col-lg-8 col-md-6">
                                    <textarea class="form-control mb-10" name="comment" placeholder="Comment" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Messege'" required=""></textarea>
