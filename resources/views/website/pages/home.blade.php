                    ...
                    <div class="container">
                        <div class="row fullscreen d-flex align-items-center justify-content-center">
                            ...
                            <div class="col-lg-5  col-md-6 header-right">
                                ...
                                <form class="form" role="form" autocomplete="off" method="POST" action="{{ url('/bookcar') }}" enctype="multipart/form-data">
				...
				<div class="container-fluid">				
					<div class="row justify-content-center align-items-center">
						<div class="col-lg-6 no-padding home-about-left">
							<img class="img-fluid" src="website/img/about-img.jpg" alt="">
						</div>
					...
					<div class="active-model-carusel">
						<div class="row align-items-center single-model item">
							...
							<div class="col-lg-6 model-right">
								<img class="img-fluid" src="website/img/car.jpg" alt="">
							</div>
						</div>
						<div class="row align-items-center single-model item">
							<div class="col-lg-6 model-left">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 single-blog">
							<div class="thumb">
								<img class="img-fluid" src="website/img/b1.jpg" alt="">								
							</div>
						...
						<div class="col-lg-3 col-md-6 single-blog">
							<div class="thumb">
								<img class="img-fluid" src="website/img/b2.jpg" alt="">								
							</div>
							<p class="date">10 Jan 2018</p>
							<a href="blog-single.html"><h4>Addiction When Gambling
							Becomes A Problem</h4></a>
						...
						<div class="col-lg-3 col-md-6 single-blog">
							<div class="thumb">
								<img class="img-fluid" src="website/img/b3.jpg" alt="">								
							</div>
							<p class="date">10 Jan 2018</p>
							<a href="blog-single.html"><h4>Addiction When Gambling
							Becomes A Problem</h4></a>
						...
						<div class="col-lg-3 col-md-6 single-blog">
							<div class="thumb">
								<img class="img-fluid" src="website/img/b4.jpg" alt="">								
							</div>
							<p class="date">10 Jan 2018</p>
							<a href="blog-single.html"><h4>Addiction When Gambling
							Becomes A Problem</h4></a>
